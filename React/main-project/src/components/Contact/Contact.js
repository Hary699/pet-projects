        ...
        return (
            <div className='contact-container'>
                ...
                <div className='bussines-card'>
                    ...
                    <div className='card-page-right-bottomn'><p><FontAwesomeIcon icon={faGlobe} />  <a href="https://github.com/Hary699" target="_blank" rel="noopener noreferrer">github.pl/Hary699</a></p></div>
                </div>
            </div>
        )
    }
